...
include_once("connector.php");
	...
	$last = false;
	$lat;$lng;$city;$i;$pre;
	$prelat;$prelng;$precity;$prei;
	// Results loop
	$numResults = mysqli_num_rows($result);
	while(($geo = mysqli_fetch_array($result)) || $last==true)
	{
	 ...
	 $lng = $geo['lng'];
	 $city = $geo['city'];
	 $content .= '<b><a href="project.php?id='.$geo['pID'].'">'.$geo['title'].'</a></b><br>';
	 }else
	 {
	 $i = $prei;
	 $lat = $prelat;
	...
	$last = false;
	 ...
	 $content .= '<b><a href="project.php?id='.$geo['pID'].'">'.$geo['title'].'</a></b><br>';
		...
		$pre = '<b><a href="project.php?id='.$geo['pID'].'">'.$geo['title'].'</a></b><br>';
		$prei=$geo['cID'];
		$prelat = $geo['lat'];
		$prelng = $geo['lng'];
		$precity = $geo['city'];
      ...
      <!-- End Loop Categories-->
          ...
          <div class="grid_8 marked-category">
            <div class="wrap-title clearfix">
              ...
              <a href="all-projects.php" class="count-project be-fc-orange">Alle Projekte</a> </div>
            <div class="box-marked-project project-short">
              <div class="top-project-info">
                <div class="content-info-short clearfix"> <a href="project.php?id=<?php echo $fProjectID;?>" class="thumb-img">
                    <img src="<?php echo $fImage; ?>" alt="$TITLE"> </a>
                  <div class="wrap-short-detail">
                    <h3 class="rs acticle-title"><a class="be-fc-orange" href="project.php?id=<?php echo $fProjectID;?>"><?php echo $fTitle;?></a></h3>
                    <p class="rs tiny-desc">von <a href="profile.php?id=<?php echo $fAuthorID; ?>" class="fw-b fc-gray be-fc-orange"><?php echo $fAuthor;?></a> in 
