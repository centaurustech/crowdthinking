...
<head>
    <title>All pages | <?php echo "title"; ?></title>
...
<div id="wrapper">
            ...
            <div class="container_12 clearfix">
                <div class="grid_12">
                    <nav class="top-menu">
                        ...
                        <div id="right-menu">
                            <ul class="alternate-menu">
                                <li><a href="index-2.html">Home(links Index-2)</a></li>
                    ...
                    <div class="top-message clearfix">
                        ...
                        <span class="txt-message"><?php echo "top-message_clearfix";?></span>
                        <i class="icon iX"></i>
                        <div class="clear"></div>
                    </div>
    ...
    <div class="layout-2cols">
                ...
                <div class="box-single-content">
                    <div class="editor-content">
                        <ul style="list-style: decimal">
							<li><a target="_blank" href="index-2.html">Home(index-2.html)</a></li>
        ...
        <div class="sidebar grid_4">
            <div class="box-gray">
                ...
                <p class="rs description pb20"><?php echo "sections_description";?>p>
            ...
            <div class="box-gray">
                ...
                <p class="rs description pb20"><?php echo "text_widget_description";?></p>
    ...
    <div class="additional-info-line">
        <div class="container_12">
            <div class="grid_9">
                <h2 class="rs title"><?php echo "additional-info-line_title";?></h2>
                <p class="rs description"><?php echo "additional-info-line_descrition";?></p>
            </div>
    ...
    <footer id="footer">
        <div class="container_12 main-footer">
            ...
            <div class="grid_3 email-newsletter">
                ...
                <div class="inner">
                    <p class="rs description"><?php echo "newsletter_description";?></p>
                    <form action="#">
        ...
        <div class="copyright">
            <div class="container_12">
                <div class="grid_12">
                    <a class="logo-footer" href="index-2.html"><img src="images/sample.png" alt="$SITE_NAME"/></a>
        ...
        <div class="grid_6 prefix_1">
            <div class="form login-form">
                <form action="#">
                    ...
                    <div class="box-white">
                        <h4 class="rs title-box">New to <?php echo "page_title";?>?</h4>
                        <p class="rs">A <?php echo "page_Title";?> account is required to continue.</p>
