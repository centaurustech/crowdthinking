...
<!-- Mirrored from envato.megadrupal.com/html/kickstars/day-news.html by HTTrack Website Copier/3.x [XR&CO'2013], Thu, 06 Jun 2013 09:24:42 GMT -->
<head>
    <title>Day news | <?php echo "title" ?></title>
    ...
    <div class="day-news">
        <div class="top-nav-news">
            <div class="container_12">
                <div class="grid_12">
                    <h3 class="common-title"><?php echo "newsletters" ?>  / <span class="fc-orange"><?php echo "day-news_date" ?></span></h3>
                </div>
                <div class="clear"></div>
                <div class="nav-item grid_4">
                    <h3 class="rs title"><a href="#" class="be-fc-orange fc-gray">Previous Day Theme</a></h3>
                    <p class="rs time fc-gray"><?php echo "day-news_date1" ?></p>
                </div>
                <div class="nav-item grid_4 ta-c">
                    <h3 class="rs title"><a href="#" class="be-fc-orange fc-gray">Next Day Theme</a></h3>
                    <p class="rs time fc-gray"><?php echo "day-news_date2" ?></p>
                </div>
                <div class="nav-item grid_4 ta-r">
                    <h3 class="rs title"><a href="#" class="be-fc-orange fc-gray">Next Day Theme</a></h3>
                    <p class="rs time fc-gray"><?php echo "day-news_date3" ?></p>
                </div>
                <div class="clear"></div>
            </div>
        </div>
                    ...
                    <div class="top-project-info">
                        <div class="content-info-short clearfix">
                            ...
                            <div class="wrap-short-detail">
                                <h3 class="rs acticle-title"><a class="be-fc-orange" href="#"><?php echo "day-news_project_title1" ?></a></h3>
                                <p class="rs tiny-desc">by <a href="#" class="fw-b fc-gray be-fc-orange"><?php echo "day-news_project_author1" ?></a> in <span class="fw-b fc-gray"><?php echo "day-news_project_location1" ?></span></p>
                                <p class="rs title-description"><?php echo "day-news_project_desc1" ?></p>
                            </div>
                            <p class="rs clearfix comment-view">
                                <a href="#" class="fc-gray be-fc-orange"><?php echo "day-news_project_comcount1" ?></a>
                                <span class="sep">|</span>
                                <a href="#" class="fc-gray be-fc-orange"><?php echo "day-news_project_views1" ?></a>
                            </p>
                        </div>
                ...
                <div class="project-short">
                    <div class="top-project-info">
                        <div class="content-info-short clearfix">
                            ...
                            <div class="wrap-short-detail">
                                <h3 class="rs acticle-title"><a class="be-fc-orange" href="#"><?php echo "day-news_project_title2" ?></a></h3>
                                <p class="rs tiny-desc">by <a href="#" class="fw-b fc-gray be-fc-orange"><?php echo "day-news_project_author2" ?></a> in <span class="fw-b fc-gray"><?php echo "day-news_project_location2" ?></span></p>
                                <p class="rs title-description"><?php echo "day-news_project_desc2" ?></p>
                            </div>
                            <p class="rs clearfix comment-view">
                                <a href="#" class="fc-gray be-fc-orange"><?php echo "day-news_project_comcount2" ?></a>
                                <span class="sep">|</span>
                                <a href="#" class="fc-gray be-fc-orange"><?php echo "day-news_project_views2" ?></a>
                            </p>
                        </div>
                    </div><!--end: .top-project-info -->
                </div>
                <div class="project-short">
                    <div class="top-project-info">
                        <div class="content-info-short clearfix">
                            ...
                            <div class="wrap-short-detail">
                                <h3 class="rs acticle-title"><a class="be-fc-orange" href="#"><?php echo "day-news_project_title3" ?></a></h3>
                                <p class="rs tiny-desc">by <a href="#" class="fw-b fc-gray be-fc-orange"><?php echo "day-news_project_author3" ?></a> in <span class="fw-b fc-gray"><?php echo "day-news_project_location3" ?></span></p>
                                <p class="rs title-description"><?php echo "day-news_project_desc3" ?></p>
                            </div>
                            <p class="rs clearfix comment-view">
                                <a href="#" class="fc-gray be-fc-orange"><?php echo "day-news_project_comcount3" ?></a>
                                <span class="sep">|</span>
                                <a href="#" class="fc-gray be-fc-orange"><?php echo "day-news_project_views3" ?></a>
                            </p>
                        </div>
                    </div><!--end: .top-project-info -->
                </div>
    ...
    <footer id="footer">
        <div class="container_12 main-footer">
            <div class="grid_3 about-us">
                ...
                <p class="rs description"><?php echo "aboutDescription" ?></p>
                <p class="rs email"><a class="fc-default  be-fc-orange" href="mailto:info@megadrupal.com"><?php echo "contactmail" ?></a></p>
            ...
            <div class="grid_3">
                ...
                <div class="footer-menu">
                    <ul class="rs">
                        <li><a class="be-fc-orange" href="#">What is <?php echo "platformName" ?>(sr)</a></li>
